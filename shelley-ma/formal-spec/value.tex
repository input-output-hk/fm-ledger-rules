...
\begin{itemize}
  ...
  \item $\mathsf{size}$ returns the size (in units of memory, eg. bytes or words) of a $\Value$. This function
  depends on the representation of $\Value$ specific to the implementation
